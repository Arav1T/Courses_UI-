...
export const StickyScroll = ({ content, contentClassName }: StickyScrollProps) => {
  ...
  const ref = useRef<HTMLDivElement>(null); // ✅ Replace `any` with HTMLDivElement
  const { scrollYProgress } = useScroll({
    container: ref, // If you want full page scroll, comment this line and uncomment the one below
    // target: ref,
    offset: ["start start", "end start"],
  });
